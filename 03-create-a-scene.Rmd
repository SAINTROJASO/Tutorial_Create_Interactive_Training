...
2. Open the `1_Project_Videos` folder.
...
1. In the **Project** panel, open the following path:
   ...
   `Assets > Scenes > 2_Project_Scenes`
...
2. In the right side you will see the following scenes 0_Menu_Scene, X_Template and LAST_SCENE
...
1. Double-click the scene you want to upload the videos.
...
> **Note:** In this section you will to edit the content of the instructions for each question, the content of each question, the content of the multiple answers for each questions, which answer will be considered correct, the content of the correct feedback (i.e., when answering correct) and corrective feedback (i.e., when answering incorrect) 

1. Use the template you created on the Training Plan to identify the number of questions you will ask in the video, and how many multiple answers each question will have (you can choose between 2 and 4 multiple answers). 
2. Copy the objects Two multiple choice answers or Four multiple choice answers, so that they correspond to your number of questions
3. Go to the inspector panel to the section **_EDIT EVERYTHING BELOW THIS_** to:
...
3.3. Edit the content of the multiple answers: change the text that says `Write the content of the answer here`
3.4. Edit the content of the correct feedback: change the text that says `Write your corrective feedback here`
3.5. Edit the content of the corrective feedback: change the text that says `Write your corrective feedback here`
4. To choose which answer will be considered as correct, write the number of the answer in the Correct Button Index section.
> **Note:** You have the option of providing more detailes corrective feedback if the participant answers wrong multiple times the same question. You can write more detailed feedback on the subsections `Wrong feedback 2`, `Wrong Feedback 3` and `Wrong feedback 4`. 
