...
<!--chapter:end:01-setup-programs.Rmd-->
...
<!--chapter:end:02-design-training-plan.Rmd-->
...
```{r import-project-image, echo=FALSE, out.width="80%", fig.align="center", fig.cap="Importing the project into Unity Hub."}
...
2. Leave the scenes open End scren in the hierarchy panel and 
...
<!--chapter:end:03-create-a-scene.Rmd-->
